...
; ==============
;	macro que c'est nous qu'on a fait !
; ==============

.macro DIV16	; a0, a1
	lsr @0		; divise par 16 l'information contenue dans 10 bits (a1:a0) et met le résultat dans a0
	lsr @0		; on met @1 à 0b00000000
	lsr @0
	lsr @0
...
//entrée registre r25 qui contient un chiffre de 0 à 255. La macro attend r25*10 ms
.macro WAIT_REG
	tst r25									         	
	breq PC+4  //si r25 = 0 on va direct à la fin    
	dec r25											 
	WAIT_MS 10
	jmp PC-3										 
.endmacro
